...
const Banner = () => {
      return (
            <div>
                  <div className="bannerStyle w-full h-[400px] relative mb-20">
                        ...
                        <div className="text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                              ...
                              <input className='rounded-l-lg w-96 h-14 text-[#0b0b0b66] bg-[#FFF] border border-solid border-[#DEDEDE] pl-4' type="text" placeholder="Search here...." />
